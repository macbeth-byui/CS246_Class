...
One student pointed out that instead of the World class extending Canvas, that JPanel would work better.  Indeed it does.  You also have to change void paint function to be paintComponent as follows:
